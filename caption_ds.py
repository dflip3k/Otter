...
def train_one_epoch(
    ...
    for num_steps, (batch_multi_instruct) in tqdm(
        ...
        # if ((num_steps + 1) % args.save_steps == 0) and args.rank == 0:
        ...
        #         },
        #         f"{args.external_save_dir}/checkpoint_latest.pt",
        #     )
...
def main():
    ...
    parser.add_argument(
        "--save_steps", type=int, default=2000, help="save every n steps"
    )
    ...
    parser.add_argument(
        "--data_root",
        type=str,
        help="data root for coco dataset",
    )
    ...
    # multi_instruct_loader = get_data(args, tokenizer, "coco_caption")
    multi_instruct_loader = get_data(args, tokenizer, "qa")
    ...
    for epoch in range(resume_from_epoch, args.num_epochs):
        # multi_instruct_loader.set_epoch(epoch)
